...
#main2{
	width:140px;
	height: 140px;
	background: url(img/photo-page-001.jpg);
	border-radius: 50%;
...
<body>
	...
	<ul >
			...
			<div id="main">
				<div id="main2"></div>
				<h2>Sameer Keswani</h2>
				
			    <p> I have done B.E in IT from VESIT, Chembur. I am a web developer with 3 years
of self-project experiences.I have also worked on different
programming languages such as, HTML, CSS, JavaScript, PHP, MYSQL, PYTHON and JAVA.Now I am Learning Django.
